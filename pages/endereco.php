    ...
    <main>
        ...
        <form action="" method="post">
            <div class="emailAlterar">
                <label for="">Cidade: 
                    <input type="email" name="emailAlterar" id="emailAlterar" value="<?php echo '';?>">
                </label>
            </div>
            <div class="nomeAlterar">
                <label for="">Endereço: 
                    <input type="text" name="nomeAlterar" id="nomeAlterar" value="<?php echo '';?>">
                </label>
            </div>
            <div class="senhaAlterar">
                <label for="">Cep: 
                    <input type="text" name="senhaAlterar" id="senhaAlterar" value="<?php echo '';?>">
                </label>
            </div>
            <div class="telAlterar">
                <label for="">Bairro:
                    <input type="tel:" name="telefoneAlterar" id="telefoneAlterar" value="<?php echo '';?>">
                </label>
            </div>
            <div class="cepAlterar">
                <label for="">Rua:
                    <input type="text" name="cepAlterar" id="cepAlterar" value="<?php echo '';?>">
                </label>
            </div>
            <div class="cpfAlterar">
                <label for="">Nº:
                    <input type="text" name="cpfAlterar" id="cpfAlterar" value="<?php echo '';?>">
                </label>
            </div>
